 ...
 */
@Service
public class CountryTrainingCarSuperviseService {
	private Logger logger = LoggerFactory.getLogger(CountryTrainingCarSuperviseService.class);
	@Resource
	...
	public Result trainingcar(Map<String,Object> params) throws Exception{
		...
		String url = countrySuperviseUrl + "/trainingcar?v=" + version + "&ts=" + timestamp + "&sign=" + signStr +"&user="+certsn;
