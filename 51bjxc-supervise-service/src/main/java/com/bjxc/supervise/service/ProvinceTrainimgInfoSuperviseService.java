 ...
 */
@Service
public class ProvinceTrainimgInfoSuperviseService {
	private Logger logger = LoggerFactory.getLogger(ProvinceTrainimgInfoSuperviseService.class);	@Resource
	...
	public Result trainimginfo(Map<String,Object> params) throws Exception{
		...
		String url = provinceSuperviseUrl + "/trainimginfo?v=" + version + "&ts=" + timestamp + "&sign=" + signStr +"&user="+certsn;
		//logger.info("TrainimgInfo url:" + url);
