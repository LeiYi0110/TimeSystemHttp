 ...
 */
@Service
public class CountryExaminerSuperviseService {
	private Logger logger = LoggerFactory.getLogger(CountryExaminerSuperviseService.class);
	@Resource
	...
	public Result examiner(Map<String,Object> params) throws Exception{
		...
		String url = countrySuperviseUrl + "/examiner?v=" + version + "&ts=" + timestamp + "&sign=" + signStr +"&user="+certsn;
