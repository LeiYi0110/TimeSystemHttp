 ...
 */
@Service
public class ProvinceExaminerSuperviseService {
	private Logger logger = LoggerFactory.getLogger(ProvinceExaminerSuperviseService.class);	@Resource
	...
	public Result examiner(Map<String,Object> params) throws Exception{
		...
		String url = provinceSuperviseUrl + "/examiner?v=" + version + "&ts=" + timestamp + "&sign=" + signStr +"&user="+certsn;
