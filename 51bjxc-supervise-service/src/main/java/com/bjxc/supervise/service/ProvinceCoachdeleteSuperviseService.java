 ...
 */
@Service
public class ProvinceCoachdeleteSuperviseService {
	private Logger logger = LoggerFactory.getLogger(ProvinceCoachdeleteSuperviseService.class);	@Resource
	...
	public Result coach(Map<String,Object> params) throws Exception{
		...
		Sign sign = new Sign();
		String dataJSON = (String)params.get("coachnum");
		String urlAction = "/coach-" + (String)params.get("coachnum");
