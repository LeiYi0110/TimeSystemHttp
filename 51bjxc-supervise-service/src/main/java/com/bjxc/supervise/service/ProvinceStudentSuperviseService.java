 ...
 */
@Service
public class ProvinceStudentSuperviseService {
	private Logger logger = LoggerFactory.getLogger(ProvinceStudentSuperviseService.class);	@Resource
	...
	public Result student(Map<String,Object> params) throws Exception{
		...
		String url = provinceSuperviseUrl + "/student?v=" + version + "&ts=" + timestamp + "&sign=" + signStr +"&user="+certsn;
		//logger.info("Student url:" + url);
