 ...
 */
@Service
public class ProvinceRegiondeleteSuperviseService {
	private Logger logger = LoggerFactory.getLogger(ProvinceRegiondeleteSuperviseService.class);	@Resource
	...
	public Result region(Map<String,Object> params) throws Exception{
		long timestamp = new Date().getTime();
		String certsn = privateKeyFactory.getCertsn();
		Sign sign = new Sign();
		String dataJSON = (String)params.get("inscode") + (String)params.get("seq");
		String urlAction = "/" + (String)params.get("inscode") + "-region-" + (String)params.get("seq");
