 ...
 */
@Service
public class ProvinceComplaintSuperviseService {
	private Logger logger = LoggerFactory.getLogger(ProvinceComplaintSuperviseService.class);	@Resource
	...
	public Result complaint(Map<String,Object> params) throws Exception{
		...
		String url = provinceSuperviseUrl + "/complaint?v=" + version + "&ts=" + timestamp + "&sign=" + signStr +"&user="+certsn;
