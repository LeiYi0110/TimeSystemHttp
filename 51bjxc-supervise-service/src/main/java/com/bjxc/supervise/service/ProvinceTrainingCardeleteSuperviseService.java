 ...
 */
@Service
public class ProvinceTrainingCardeleteSuperviseService {
	private Logger logger = LoggerFactory.getLogger(ProvinceTrainingCardeleteSuperviseService.class);	@Resource
	...
	public Result trainingcar(Map<String,Object> params) throws Exception{
		long timestamp = new Date().getTime();
		String certsn = privateKeyFactory.getCertsn();
		Sign sign = new Sign();
		String dataJSON = params.get("carnum").toString();
		String urlAction = "/trainingCar-" + params.get("carnum").toString();
		...
		//logger.info("TrainingCar url:" + url);
