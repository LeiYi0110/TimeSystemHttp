 ...
 */
@Service
public class ProvinceTrainingCarSuperviseService {
	private Logger logger = LoggerFactory.getLogger(ProvinceTrainingCarSuperviseService.class);	@Resource
	...
	public Result trainingcar(Map<String,Object> params) throws Exception{
		...
		String url = provinceSuperviseUrl + "/trainingcar?v=" + version + "&ts=" + timestamp + "&sign=" + signStr +"&user="+certsn;
