 ...
 */
@Service
public class ProvinceTransferSuperviseService {
	private Logger logger = LoggerFactory.getLogger(ProvinceTransferSuperviseService.class);	@Resource
	...
	public Result  transfer(Map<String,Object> params) throws Exception{
		...
		String url = provinceSuperviseUrl + "/transfer?v=" + version + "&ts=" + timestamp + "&sign=" + signStr +"&user="+certsn;
		//logger.info("Transfer url:" + url);
