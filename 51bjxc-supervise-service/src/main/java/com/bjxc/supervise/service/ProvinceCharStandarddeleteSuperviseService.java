 ...
 */
@Service
public class ProvinceCharStandarddeleteSuperviseService {
	private Logger logger = LoggerFactory.getLogger(ProvinceCharStandarddeleteSuperviseService.class);	@Resource
	...
	public Result charstandard(Map<String,Object> params) throws Exception{
		long timestamp = new Date().getTime();
		String certsn = privateKeyFactory.getCertsn();
		Sign sign = new Sign();
		String dataJSON = (String)params.get("inscode") + (String)params.get("seq");
		String urlAction = "/" + (String)params.get("inscode") + "-CharStandard-" + (String)params.get("seq");
