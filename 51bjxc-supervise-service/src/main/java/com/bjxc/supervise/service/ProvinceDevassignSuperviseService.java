 ...
 */
@Service
public class ProvinceDevassignSuperviseService {
	private Logger logger = LoggerFactory.getLogger(ProvinceDevassignSuperviseService.class);	@Resource
	...
	public Result devassign(Map<String,Object> params) throws Exception{
		...
		String url = provinceSuperviseUrl + "/devassign?v=" + version + "&ts=" + timestamp + "&sign=" + signStr +"&user="+certsn;
