 ...
 */
@Service
public class ProvinceEvaluationSuperviseService {
	private Logger logger = LoggerFactory.getLogger(ProvinceEvaluationSuperviseService.class);	@Resource
	...
	public Result evaluation(Map<String,Object> params) throws Exception{
		...
		String url = provinceSuperviseUrl + "/evaluation?v=" + version + "&ts=" + timestamp + "&sign=" + signStr +"&user="+certsn;
		//logger.info("Evaluation url:" + url);
