 ...
 */
@Service
public class ProvinceClassRecordSuperviseService {
	private Logger logger = LoggerFactory.getLogger(ProvinceClassRecordSuperviseService.class);	@Resource
	...
	public Result classrecord(Map<String,Object> params) throws Exception{
		...
		String url = provinceSuperviseUrl + "/classrecord?v=" + version + "&ts=" + timestamp + "&sign=" + signStr +"&user="+certsn;
