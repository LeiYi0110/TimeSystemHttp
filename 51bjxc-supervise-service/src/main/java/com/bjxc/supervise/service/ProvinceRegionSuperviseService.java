 ...
 */
@Service
public class ProvinceRegionSuperviseService {
	private Logger logger = LoggerFactory.getLogger(ProvinceRegionSuperviseService.class);	@Resource
	...
	public Result region(Map<String,Object> params) throws Exception{
		...
		String url = provinceSuperviseUrl + "/region?v=" + version + "&ts=" + timestamp + "&sign=" + signStr +"&user="+certsn;
