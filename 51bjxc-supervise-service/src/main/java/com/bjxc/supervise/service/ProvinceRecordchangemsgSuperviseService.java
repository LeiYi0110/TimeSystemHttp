 ...
 */
@Service
public class ProvinceRecordchangemsgSuperviseService {
	private Logger logger = LoggerFactory.getLogger(ProvinceRecordchangemsgSuperviseService.class);	@Resource
	...
	public Result recordchangemsg(Map<String,Object> params) throws Exception{
		...
		String url = provinceSuperviseUrl + "/recordchangemsg?v=" + version + "&ts=" + timestamp + "&sign=" + signStr +"&user="+certsn;
		//logger.info("Recordchangemsg url:" + url);
