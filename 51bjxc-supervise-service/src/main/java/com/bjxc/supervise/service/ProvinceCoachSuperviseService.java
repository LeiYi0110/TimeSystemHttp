 ...
 */
@Service
public class ProvinceCoachSuperviseService {
	private Logger logger = LoggerFactory.getLogger(ProvinceCoachSuperviseService.class);	@Resource
	...
	public Result coach(Map<String,Object> params) throws Exception{
		...
		String url = provinceSuperviseUrl + "/coach?v=" + version + "&ts=" + timestamp + "&sign=" + signStr +"&user="+certsn;
