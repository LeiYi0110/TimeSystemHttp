 ...
 */
@Service
public class ProvinceSecurityguardSuperviseService {
	private Logger logger = LoggerFactory.getLogger(ProvinceSecurityguardSuperviseService.class);	@Resource
	...
	public Result securityguard(Map<String,Object> params) throws Exception{
		...
		String url = provinceSuperviseUrl + "/securityguard?v=" + version + "&ts=" + timestamp + "&sign=" + signStr +"&user="+certsn;
