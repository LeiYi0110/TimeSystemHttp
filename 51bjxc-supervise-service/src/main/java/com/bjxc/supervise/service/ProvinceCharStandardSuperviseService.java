 ...
 */
@Service
public class ProvinceCharStandardSuperviseService {
	private Logger logger = LoggerFactory.getLogger(ProvinceCharStandardSuperviseService.class);	@Resource
	...
	public Result charstandard(Map<String,Object> params) throws Exception{
		...
		String url = provinceSuperviseUrl + "/CharStandard?v=" + version + "&ts=" + timestamp + "&sign=" + signStr +"&user="+certsn;
