 ...
 */
@Service
public class ProvinceDevRembindingSuperviseService {
	private Logger logger = LoggerFactory.getLogger(ProvinceDevRembindingSuperviseService.class);	@Resource
	...
	public Result devrembinding(Map<String,Object> params) throws Exception{
		...
		String url = provinceSuperviseUrl + "/devRembinding?v=" + version + "&ts=" + timestamp + "&sign=" + signStr +"&user="+certsn;
		//logger.info("DevRembinding url:" + url);
