 ...
 */
@Service
public class ProvinceDevicedeleteSuperviseService {
	private Logger logger = LoggerFactory.getLogger(ProvinceDevicedeleteSuperviseService.class);	@Resource
	...
	public Result device(Map<String,Object> params) throws Exception{
		...
		Sign sign = new Sign();
		String dataJSON = (String)params.get("devnum");
		String urlAction = "/device-" + (String)params.get("devnum");
