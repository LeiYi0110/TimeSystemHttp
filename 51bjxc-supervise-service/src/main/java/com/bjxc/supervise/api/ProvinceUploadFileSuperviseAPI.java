...
@RestController
@RequestMapping("/province/upload")
public class ProvinceUploadFileSuperviseAPI {
	
	private static final Logger logger = LoggerFactory.getLogger(ProvinceUploadFileSuperviseAPI.class);
	@Resource
	private ProvinceUploadFileSuperviseService service;
